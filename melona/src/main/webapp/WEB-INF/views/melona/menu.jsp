	...
	<div class="col-sm-3">
		<ul class="nav navbar-nav navbar-right">
			<li class="${current_page eq 'ticket' ? 'active' : '' }"><a
				href=""><img src="resources/icons/메로나 티켓.png" alt=""></a>
			</li>
		</ul>
	</div>
	<div class="col-sm-1"></div>
	...
	<div class="col-sm-10">
		<ul class="nav navbar-nav">
			<li class="${current_page eq 'main' ? 'active' : '' }"><a
				href="chart.do"><img src="resources/icons/메로나 차트.png" alt=""></a>
			</li>
		...
		<ul class="nav navbar-nav navbar-right">
			<li class="${current_page eq 'main' ? 'active' : '' }"><a
				href="main.do"><img src="resources/icons/마이 뮤직.png" alt=""></a>
			</li>
		</ul>
	</div>
</div>
